...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#image05', { style: 'blur-in', speed: 1250, intensity: 7, delay: 125, replay: false });
		onvisible.add('#text45', { style: 'fade-down', speed: 1000, intensity: 5, delay: 125, replay: false });
		onvisible.add('#icons02', { style: 'fade-left', speed: 1000, intensity: 5, delay: 250, stagger: 125, staggerSelector: ':scope > li', replay: false });
		onvisible.add('#buttons03', { style: 'fade-left', speed: 1000, intensity: 5, delay: 375, replay: false });
